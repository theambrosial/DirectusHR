...
class ClientRecruiterRequest extends Component {
    constructor(props) {
        super(props);
    ...
    createRequest(data){
      ...
      if (csrfToken !== undefined) {
          ...
          .then(function(response){
              ...
              if(responseData.country_code_mobile[0]){
        ...
        if (this.props.user_role === 'Client'){
         ...
         if (user_role === 'Recruiter (Freelancer)'){
            this.setState({
                "is_outside_rec": true,
                "user_role": user_role
            })
        ...
        let value = event.target.value
         if (key === 'country_code_mobile'){
            if (value === ""){
                alert("Select Valid Country Code!")
            }
        }
        this.setState({
            [key]: value
    ...
    render() {
		...
		<option data-countrycode="ZW" value="263">Zimbabwe (+263)</option>
          ...
          <Col sm={6} md={6} lg={6}>
          <p style={{ fontWeight: "500", }}> Type of Registration</p>
...
export default ClientRecruiterRequest;
