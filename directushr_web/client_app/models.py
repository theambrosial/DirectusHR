...
from common_utilities.available_choices import Relations, available_business_types, available_company_sizes
...
class ManpowerRequisition(models.Model):
    ...
    position_type = models.CharField(choices=Relations.available_relations,max_length=20)
