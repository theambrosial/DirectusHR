...
from common_utilities.available_choices import available_relations, available_business_types, available_company_sizes, available_interview_status
...
class CandidateModel(models.Model):
    ...
    candidate_cv = models.FileField(upload_to='candidate_cv/')
    ...
    added_by_recruiter = models.ForeignKey(RecruiterModel, on_delete=models.CASCADE)
